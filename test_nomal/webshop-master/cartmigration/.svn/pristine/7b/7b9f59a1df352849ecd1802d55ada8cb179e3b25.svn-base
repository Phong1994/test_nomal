<ol>
    ...
    <li>Name the file as <b><i>customers.dat</i></b>, set <b>Legacy Import Customers From Flat File</b> Format and <b>Tab</b>
        as File Delimiter.
    </li>
    <li>Fill in the box to <b>Export Field Names as Header</b>.</li>
    <li>Select <b>Login Pass; Recovery Email Ship; First Name Ship; Last Name Ship; Email Ship; Phone Ship; Fax Ship;
            Company Ship; Address Ship; City Ship; State Ship; Zip Ship; Country Bill; First Name Bill; Last Name Bill;
            Phone Bill; Fax Bill; Email Bill; Company Bill; Address Bill; City Bill; State Bill; Zip Bill; Country</b>
        fields to export.
    </li>
